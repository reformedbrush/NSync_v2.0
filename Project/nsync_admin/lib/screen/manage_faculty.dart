                        ...
                        cells: [
                          ...
                          DataCell(
                            Container(
                              ...
                              height: 40,
                              child:
                                  entry.value['faculty_photo'] != null
                                      ? ClipRRect(
                              ...
                              onPressed: () {
                                setState(() {
                                  _facultyController.text =
                                      entry.value['faculty_name'];
                                  _facDesignationController.text =
                                      entry.value['faculty_designation'];
                                  _facEmailController.text =
                                      entry.value['faculty_email'];
                          ...
                          DataCell(
                            IconButton(
                              ...
                              onPressed: () {
                                delFaculty(
                                  entry.value['faculty_id'].toString(),
                                );
                              },
                            ),
                          ),
