...
class _NewsLetterScreenState extends State<NewsLetterScreen>
  ...
  Future<String?> photoUpload() async {
    if (pickedImage == null) return null; // Prevent errors
    try {
      final bucketName = 'Newsletter';
      final filePath =
          "News-${pickedImage!.name}-${DateTime.now().millisecondsSinceEpoch}";
